        ...
        <>
            <div className="binary-transform d-flex flex-column align-items-center">
...

                {
                    type == "decimal" ? (
                        ...
                        <div className="form-check form-switch mb-3">
                            <input className="form-check-input" onChange={handleCheckedIpv4} type="checkbox" id="padding-ipv4" />
                            <label className="form-check-label" htmlFor="padding-ipv4">Rellenar en formato 8 bits</label>
                        </div>
                    )
                ...
                <button type="button" className="btn btn-success" onClick={() => {
                    setDataFetch({
                        url: isCheckedIpv4 ? `${url}${number}?padding_ipv4=true` : `${url}${number}`,
                        method: "GET",
                        typeNumber: type
